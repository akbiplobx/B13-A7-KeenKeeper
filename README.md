=KeenKeeper – Preserve Your Bonds of Friendship=
...
- Navigation – Three pages: Home, Timeline and Stats.
- Hero Section– Allows adding another friend profile to my list.

Tech Stack

- React.js – As always
- Tailwind CSS – Quick and clean styling without custom CSS
- Lucide React & React Icons – Used throughout the navbar and footer icons
- Vite – Makes everything work faster and better

How to run locally

-bash
git clone https://github.com/akbiplobx/B13-A7-KeenKeeper.git
npm install
npm run dev
